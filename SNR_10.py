 ...
 #  somemetadata = allmetadata[:5]
    ...
    for i_line in range(len(allmetadata)):
       ...
       #i_station = str(i_station)
        ...
        #check SNR
        if ((i_SNR_N >= SNR_pass)and(i_SNR_E >= SNR_pass)):
           ...
           ## save for flat file
            ...
            new_SAC_filepath_N =  top_dir +'SNR_10/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHN_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '.sac'
        
            new_SAC_filepath_E =  top_dir +'SNR_10/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHE_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '.sac'
            ...
            fig_save_N = top_dir +'SNR_10/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHN_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec +'.png'
            fig_save_E = top_dir +'SNR_10/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHE_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec +'.png'

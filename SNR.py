...
def SNR_BigBoy(top_dir,flat_file_dir,snr_pass_dir,SNR_pass,noisedur,sigdur):
 ...
 #  somemetadata = allmetadata[:5]
       ...
       #i_station = str(i_station)
        ...
        if i_SNR_ave >= SNR_pass:
           ...
           ## save for flat file
            ...
            out_SNR =  np.append(out_SNR, (i_SNR_ave)
            
            ## save sac files and move plots over 
           
            new_SAC_filepath_N =  top_dir +'SNR_2/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHN_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '.sac'
        
            new_SAC_filepath_E =  top_dir +'SNR_2/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHE_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '.sac'
            ...
            fig_save_N = top_dir +'SNR_2/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHN_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec +'.png'
            fig_save_E = top_dir +'SNR_2/Event_'+ i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec + '/' + i_network + '_' + i_station + '_HHE_' + i_year + '_' + i_month + '_' + i_day + '_' + i_hr + '_' + i_min +'_' + i_sec +'.png'
    ...
    collected_df = pd.DataFrame(collected_dict)
        ## Write to file:
    collected_df.to_csv(snr_pass_dir+'SNR_2_file'+'.csv')
